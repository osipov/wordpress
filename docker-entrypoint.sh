...
php wp-cli.phar --allow-root plugin install https://downloads.wordpress.org/plugin/hello-dolly-for-your-song.zip
php wp-cli.phar --allow-root plugin activate hello-dolly-for-your-song
